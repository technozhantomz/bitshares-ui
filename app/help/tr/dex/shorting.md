...
HomePesa ağının herhangi bir miktarda BitVarlığı piyasaya sürmesi ve yeterli teminat 
karşılığında katılımcılara borç vermesi mümkündür. 

 * *uzlaşma fiyatı* : 1 USD in dış borsalarda alıp-satılırkenki fiyatı.
...
HomePesa ağı , ödünç aldığı bitVarlığın karşılığında yeterince teminatı bulunmayan 
...
piyasa fiyatından satın alır ve pozisyonu kapar. Teminattan geri kalan USD müşteriye 
iade edilir.
...
teminat oranı arttırılırsa , ilave miktarda USD teminat olarak kilit altına alınır, teminat 
oranının düşürülmesi ise tekabül eden miktarda BitVarlığın ağa geri ödenmesini 
gerektirir.

## Kapamak

Ödünç/kısa pozisyonunu kapamak için , ilk önce kişinin , HomePesa ağına teslim 
