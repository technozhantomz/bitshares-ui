...
In order to increase your exposure to USD and offer liquidity to BitAssets, such
 ...
 * *settlement price*: The price for 1 USD as it is traded on external exchanges.
...
market rates up to the SQP and close the position. The remaining USD of the
...
increase, an additional amount of USD is locked as collateral, while reducing
